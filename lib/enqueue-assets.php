<?php
	...
	***********************************************************************/
	...
	function _themename_assets() {
		...
		wp_enqueue_script( '_themename-scripts', get_template_directory_uri() . '/dist/assets/js/main.js', array(), '1.0.1' ,   true );
...
function _themename_add_google_fonts() {
   wp_enqueue_style( '_themename-google-fonts', 'https://fonts.googleapis.com/css?family=Archivo+Narrow:400,600,700|Source+Code+Pro:300,400&display=swap', false );
   }
